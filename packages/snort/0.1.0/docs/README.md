...
This integration is for Snort device's logs. It includes the following
datasets for receiving logs over syslog or read from a file:
- `log` dataset: supports Snort/Sourcefire logs.

### Log

The `log` dataset collects Snort/Sourcefire logs.
