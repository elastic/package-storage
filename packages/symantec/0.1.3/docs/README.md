# Symantec integration (Deprecated)

_This integration is deprecated. Please use one of the other Symantec integrations
that are specific to a Symantec product._

This integration is for Symantec device's logs. It includes the following
datasets for receiving logs over syslog or read from a file:
- `endpointprotection` dataset: supports Symantec AntiVirus/Endpoint Protection logs.

### Endpointprotection

The `endpointprotection` dataset collects Symantec AntiVirus/Endpoint Protection logs.
