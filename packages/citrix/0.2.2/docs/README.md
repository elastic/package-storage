...
This integration is for Citrix device's logs. It includes the following
datasets for receiving logs over syslog or read from a file:
- `netscaler` dataset: supports Citrix NetScaler logs.

### Netscaler

The `netscaler` dataset collects Citrix NetScaler logs.
